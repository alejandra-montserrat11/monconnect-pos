        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Acabado = table.Column<string>(type: "text", nullable: false),
                    Color = table.Column<string>(type: "text", nullable: false),
                    PrecioPorMetroCuadrado = table.Column<decimal>(type: "numeric", nullable: false),
                    PrecioPorCaja = table.Column<decimal>(type: "numeric", nullable: false),
                    MetrosCuadradosPorCaja = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
                {
